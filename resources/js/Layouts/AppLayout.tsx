...
import {
    BarChart3, Bell, Building2, ChevronDown, HelpCircle, Inbox, LayoutGrid, Lightbulb,
...
const FEATURES: Feature[] = [
    ...
    { id: 'accounts', icon: Building2, label: 'LSA Accounts', short: 'Accounts', desc: 'All clients overview', href: '/accounts' },
